/*
 * button drücken ruft inkweek aus , inkweek startet timer zum entprellen, leider stoppt der Timer nicht und lässt die lampen blinken, wenn clearflag in button interupt, dann kein start des timers.
 *
 */
